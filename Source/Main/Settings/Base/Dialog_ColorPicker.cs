...
public class Dialog_ColourPicker : Window
{
    ...
    {
        get { return new Vector2((float)this._pickerSize + 3f * this._margin + (float)(2 * this._sliderWidth) + (float)(2 * this._previewSize) + 36f, (float)this._pickerSize + 36f); }
    }
    ...
    {
        bool flag = Dialog_ColourPicker.first;
        ...
        Rect position2 = new Rect(position.xMax, inRect.yMin, (float)this._previewSize, (float)this._previewSize);
        Rect rect4 = new Rect(rect3.xMax + this._margin, inRect.yMax - this._fieldHeight, (float)(this._previewSize * 2), this._fieldHeight);
        Rect rect5 = new Rect(rect3.xMax + this._margin, inRect.yMax - 2f * this._fieldHeight - this._margin, (float)this._previewSize - this._margin / 2f, this._fieldHeight);
        Rect rect6 = new Rect(rect5.xMax + this._margin, rect5.yMin, (float)this._previewSize - this._margin / 2f, this._fieldHeight);
        Rect rect7 = new Rect(rect3.xMax + this._margin, inRect.yMax - 3f * this._fieldHeight - 2f * this._margin, (float)(this._previewSize * 2), this._fieldHeight);
        ...
        Rect rect8 = new Rect(rect2.xMin - 3f, rect2.yMin + this._huePosition - (float)(this._handleSize / 2), (float)this._sliderWidth + 6f, (float)this._handleSize);
        Rect rect9 = new Rect(rect3.xMin - 3f, rect3.yMin + this._alphaPosition - (float)(this._handleSize / 2), (float)this._sliderWidth + 6f, (float)this._handleSize);
        Rect rect10 = new Rect(rect.xMin + this._position.x - (float)(this._handleSize / 2), rect.yMin + this._position.y - (float)(this._handleSize / 2), (float)this._handleSize, (float)this._handleSize);
        ...
        Widgets.DrawBox(rect8, 1, null);
        Widgets.DrawBox(rect9, 1, null);
        Widgets.DrawBox(rect10, 1, null);
        ...
        if (Widgets.ButtonText(rect4, "OK", true, false, true, null))
        {
            this.SetColor();
            this.Close(true);
        }

        if (Widgets.ButtonText(rect5, "Apply", true, false, true, null))
        {
            this.SetColor();
        }

        if (Widgets.ButtonText(rect6, "Cancel", true, false, true, null))
        {
            this.Close(true);
        }
