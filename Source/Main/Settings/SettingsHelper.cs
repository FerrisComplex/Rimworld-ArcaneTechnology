...
{ internal static class SettingsHelper
    {
        ...
        public static void RegisterSettingModules()
        {
            ...
            VanillaCategory = new TechnologyLevelSettings("Arcane Technology", "Restricts equipment and items based on tech level, HIGHLY recommended to use Tech Advancing & Ignorance is Bliss with this!");
